...
export const DriversPage: React.FC = () => {
 ...
 {(() => {
 const lWarn = getDriverLicenseWarning(d, company);
 if (!lWarn.hasWarning) return null;
 return (
 <div style={{ marginTop: "4px" }}>
 <span style={{ background: lWarn.isOverdue ? "#fee2e2" : "#fef3c7", color: lWarn.isOverdue ? "#dc2626" : "#b45309", padding: "2px 6px", borderRadius: "4px", fontSize: "11px", fontWeight: 600, display: "inline-flex", alignItems: "center", gap: "4px" }}>
 <BadgeAlert size={11} /> {lWarn.message}
 </span>
 </div>
 );
 })()}
