...
///
/// Reporting lives in exactly ONE place: the `Reports` hub (`/reports`), which
/// organizes every report into categories. Payments is an operational
/// transaction module only — it no longer carries a competing report submenu.
...
/// `/reports/machines` highlights `Reports`).
