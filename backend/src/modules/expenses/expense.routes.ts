...
expenseRouter.post("/", requirePermission("expense.manage"), asyncHandler(expenseController.createExpense));
expenseRouter.patch("/:id", requirePermission("expense.manage"), asyncHandler(expenseController.updateExpense));
expenseRouter.delete("/:id", requirePermission("expense.manage"), asyncHandler(expenseController.removeExpense));
